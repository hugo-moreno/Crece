...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cert-btn { background: var(--blue-dark); color: white; border: none; padding: 0.8rem 2rem; font-family: 'DM Sans', sans-serif; font-size: 0.85rem; font-weight: 500; cursor: pointer; transition: background 0.2s; letter-spacing: 0.02em; }
  .cert-btn:hover { background: var(--blue-mid); }
  .cert-btn-out { background: none; border: 1.5px solid var(--blue-dark); color: var(--blue-dark); padding: 0.8rem 2rem; font-family: 'DM Sans', sans-serif; font-size: 0.85rem; font-weight: 500; cursor: pointer; transition: all 0.2s; }
  .cert-btn-out:hover { background: var(--blue-mist); }

  .certificate { background: white; width: 780px; max-width: 100%; border: 1px solid var(--gray-300); position: relative; overflow: hidden; animation: fadeUp 0.4s ease both; }
  ...
  .cert-logo-name { font-family: 'Cormorant Garamond', serif; font-size: 1.6rem; font-weight: 700; color: var(--blue-dark); }
  .cert-logo-name span { color: var(--blue-light); }
  .cert-logo-sub { font-size: 0.72rem; color: var(--gray-500); letter-spacing: 0.06em; text-transform: uppercase; margin-top: 0.2rem; }
  ...
  .cert-watermark { position: absolute; bottom: 40px; right: 40px; width: 80px; height: 80px; border: 2px solid var(--blue-pale); opacity: 0.25; }

  @keyframes fadeUp { from { opacity: 0; transform: translateY(14px); } to { opacity: 1; transform: translateY(0); } }
  @media (max-width: 820px) { .certificate { width: 100%; } .cert-inner { padding: 2rem 1.5rem; } .cert-recipient { font-size: 2rem; } .cnav { padding: 0.9rem 1.5rem; } }
`;
